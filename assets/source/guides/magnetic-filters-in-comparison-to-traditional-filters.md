---
title: Magnetic Filters Compared with Other Filters
category: Filtration
...
1. **Flow rate.** The fluid must spend enough time near the rods for particles to be drawn out. A larger housing for a higher flow.
2. **Contamination load.** More iron means more rods, or more frequent cleaning.
3. **Particle size.** Fine particles need higher strength rods. SMAG rods are made up to 13,500 gauss.
